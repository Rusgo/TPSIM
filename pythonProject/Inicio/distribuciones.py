...
def uniforme(n, a, b, clases, tabla,tabla_numeros, resultadoBondad):
    ...
    Pruebas_Bondad.calculo(n, randoms[0], randoms[-1], randoms, clases, False, False, False, 0, tabla,resultadoBondad)
...
def exponencial(n, media, clases, tabla,tabla_numeros,resultadoBondad ):
    tabla.delete(*tabla.get_children())
    tabla_numeros.delete(*tabla_numeros.get_children())
    tabla_numeros.column(column="#0", width=100, minwidth=50, anchor='w')
    tabla_numeros.heading(column="#0", text="Numeros Generados", anchor='w')
    ...
    Pruebas_Bondad.calculo(n, numeros[0], numeros[-1], numeros, clases, 1/media, False, False, 1, tabla,resultadoBondad)
...
def normal(n, media, de, clases, tabla,tabla_numeros,resultadoBondad):
    tabla.delete(*tabla.get_children())
    tabla_numeros.delete(*tabla_numeros.get_children())
    tabla_numeros.column(column="#0", width=100, minwidth=50, anchor='w')
    tabla_numeros.heading(column="#0", text="Numeros Generados", anchor='w')
    ...
    Pruebas_Bondad.calculo(n, numeros_random[0], numeros_random[-1], numeros_random, clases, False, media, de, 3, tabla,resultadoBondad)
